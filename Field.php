...
class Field extends PositionOrRange implements FieldInterface, \JsonSerializable, \ArrayAccess
{
    ...
    public function setIndicators($arg)
    {
        ...
        if ($this->validateIndicators($arg)) {
            for ($x = 0; $x < strlen($arg); $x++) {
                if (0 == $x) {
                    if ('_' != $arg[$x]) {
                        $this->setIndicator1($arg[$x]);
                    }
                }
                if (1 == $x) {
                    if ('_' != $arg[$x]) {
                        $this->setIndicator2($arg[$x]);
                    }
                }
            }
        }
    ...
    public function offsetExists($offset)
    {
        switch ($offset) {
            ...
            break;
            case 'indicator1':
                return isset($this->indicator1);
            break;
            case 'indicator2':
                return isset($this->indicator2);
            break;
            case 'subSpecs':
    ...
    public function offsetGet($offset)
    {
        switch ($offset) {
            ...
            break;
            case 'indicator1':
                return $this->getIndicator1();
            break;
            case 'indicator2':
                return $this->getIndicator2();
            break;
            case 'subSpecs':
